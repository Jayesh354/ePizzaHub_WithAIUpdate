...
public partial class ePizzaHub_AIDbContext : DbContext
{
    public ePizzaHub_AIDbContext(DbContextOptions<ePizzaHub_AIDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserToke__3214EC07A3C48A80");
